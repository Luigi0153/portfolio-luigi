...
metadata:
  version: 2.0.0
description: "Conversion rate optimization for landing pages, product pages, checkout and forms. Use when a page is not converting, for CRO audits, funnel leaks or improving conversion rates."
---
