...
description: "Shopify theme and app development: Liquid files, sections, theme settings, Storefront API, checkout extensions. Use for building, customizing or debugging a Shopify store."
---
